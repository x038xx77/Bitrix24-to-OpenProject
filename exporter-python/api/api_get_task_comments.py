...
def get_task_comments(id_task, webhook):
    ...
    output_file = os.path.join(output_folder, f'task_comments_{id_task}.json')

    b = Bitrix(webhook)
    comment_items = b.get_all('task.commentitem.getlist', params={"id": id_task})
